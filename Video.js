...
Video.propTypes = {
  filter: PropTypes.oneOf([
    ...
    FilterTypeAndroid.LuminanceThreshold, 
    FilterTypeAndroid.Pixelation, 
    FilterTypeAndroid.RGBFilter, 
    FilterTypeAndroid.SHARP, 
    FilterTypeAndroid.Solarize, 
    FilterTypeAndroid.Swirl, 
    FilterTypeAndroid.Vibrance, 
    FilterTypeAndroid.ZoomBlur, 
  ]),
